...
export const SKILLS: Skill[] = [
  ...
  { name: 'Pandas', category: 'Business Analytics' },
  { name: 'NumPy', category: 'Business Analytics' },
...
export const SERVICES: ServiceItem[] = [
  {
    ...
    description:
      'Interactive Power BI dashboards built on clean data models with drill-through, slicers, and DAX-driven KPIs.',
    icon: 'powerbi',
  },

  {
    ...
    description:
      'End-to-end BI solutions that connect raw data sources to clear, decision-ready reporting.',
    icon: 'bi',
  },

  {
    ...
    description:
      'Querying, transforming, and analyzing relational data to answer business questions and support reporting.',
    icon: 'sql',
  },

  {
    ...
    title: 'Data Modeling',
    description:
      'Designing structured data models and relationships to support scalable BI reporting and analytics.',
    icon: 'bi',
  },

  {
    ...
    description:
      'Data cleaning, EDA, feature preparation, and statistical analysis using Python, Pandas, and NumPy.',
    icon: 'python',
  },

  {
    ...
    description:
      'Supervised learning workflows from EDA and preprocessing through model tuning and evaluation.',
    icon: 'ml',
  },

  {
    ...
    description:
      'Clear reports and visualizations that turn complex datasets into practical business insights.',
    icon: 'reporting',
  },

  {
    ...
    description:
      'Cleaning, transforming, and preparing raw datasets to improve data quality and support reliable analysis.',
    icon: 'reporting',
  },
];
...
export const PROJECTS: Project[] = [
  {
    ...
    tagline:
      'A 5-page Power BI dashboard on 100K+ orders, built on a star-schema model as a DEPI graduation project.',
    category: ['Power BI'],
    ...
    insights: [
      'Key business KPIs: Total Revenue 16.01M BRL, AOV 160.99, Average Review Score 4.09.',
    ...
    impact:
      'Built a star-schema model — one fact table (orders) linked to customer, product, seller, and geolocation dimensions — and turned it into a 5-page dashboard for analyzing revenue, logistics, product, seller, and customer performance.',
    role:
